...
import FrontendPatternsDetailList from "@src/app/frontend-patterns/info-list/detail"
...
export default function FrontendPatternsPage() {
    ...
    return (
        <article className={parentStyle}>
            {showDetail.state ? (
                <FrontendPatternsDetailList data={showDetail.data} closeDetail={closeMessageDetail} />
            ) : (
                <>
                    ...
                    <div className="flex flex-col gap-[4px] px-[4px]">
                        <p className="heading-xl text-gray080">Frontend Patterns</p>
                        <p className="body-sm text-gray040">Adapter, Compound Component 등 실무 React 설계 패턴</p>
                    </div>

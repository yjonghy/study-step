...
export default function HtmlCss() {
    ...
    return (
        <article className={parentStyle}>
            {/*브라우저 렌더링 과정을 설명해주세요.*/}
            <p className="text-gray060 heading-xl">브라우저 렌더링 과정</p>
            ...
            <div className="mt-[24px]">
                <p className="text-gray090 body-md">3.구문 분석</p>
            ...
            <div className="mt-[24px]">
                <p className="text-gray090 body-md">4.렌더</p>
                <p className="text-gray090 body-xs mt-[4px]">
                    -Style<br/>

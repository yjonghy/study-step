...
export default function Template() {
    ...
    const saveToPdf = async () => {
        // const input = document.getElementById('career_layout');
        // html2canvas(input)
        //     .then((canvas) => {
    ...
    return (
        <section id="career_layout" className="w-full h-full flex flex-col">
            ...
            <div
                onClick={() => saveToPdf()}
                className={`w-[200px] mt-[30px] self-center ${PrimaryButton} ${MotionFast} ${MediumBtnStyle} flex items-center justify-center rounded-[8px]`}>
                 <p className="text-white heading-sm">PDF 저장하기</p>
            </div>

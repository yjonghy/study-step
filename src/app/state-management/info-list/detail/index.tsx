...
import StateManagementCompare from "./StateManagementCompare"

export default function StateDetailList(props: any) {
    return (
        <article className="w-full flex flex-col justify-center items-center">
            ...
            {props.data === "TanStack Query"           && <TanStackQuery />}
            {props.data === "Zustand"                  && <Zustand />}
            {props.data === "상태관리 라이브러리 비교"   && <StateManagementCompare />}
        </article>
    )
}

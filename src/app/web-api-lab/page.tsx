...
import WebApiLabDetailList from "@src/app/web-api-lab/info-list/detail"
...
export default function WebApiLabPage() {
    ...
    return (
        <article className={parentStyle}>
            {showDetail.state ? (
                <WebApiLabDetailList data={showDetail.data} closeDetail={closeMessageDetail} />
            ) : (
                <>
                    ...
                    <div className="flex flex-col gap-[4px] px-[4px]">
                        <p className="heading-xl text-gray080">Web API Lab</p>
                        <p className="body-sm text-gray040">BroadcastChannel, Page Visibility API 등 브라우저 API 실험</p>
                    </div>

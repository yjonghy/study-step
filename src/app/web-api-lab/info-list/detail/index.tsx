import BroadcastChannelDoc from "./BroadcastChannel"
import PageVisibilityApi from "./PageVisibilityApi"

export default function WebApiLabDetailList(props: any) {
    return (
        <article className="w-full flex flex-col justify-center items-center">
            ...
            {props.data === "BroadcastChannel" && <BroadcastChannelDoc />}
            {props.data === "Page Visibility API" && <PageVisibilityApi />}
